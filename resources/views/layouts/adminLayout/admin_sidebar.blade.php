...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
      ...
      <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Picture</span> <span class="label label-important">3</span></a>
        <ul>
          <li><a href="{{url('/admin/picture')}}">Add Picture</a></li>
          <li><a href="{{url('/admin/view-picture')}}">View Pictures</a></li>
        </ul>
      </li>
